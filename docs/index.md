---
page_title: "notifiers-v1 Provider"
---

# notifiers-v1 Provider

This provider is used to interact with the resources provided by the **notifiers-v1** application of the [Nokia EDA](https://docs.eda.dev) platform.
