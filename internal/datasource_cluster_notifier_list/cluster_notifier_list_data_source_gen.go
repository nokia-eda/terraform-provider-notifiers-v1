...
package datasource_cluster_notifier_list
...
func ClusterNotifierListDataSourceSchema(ctx context.Context) schema.Schema {
...
type ClusterNotifierListModel struct {
