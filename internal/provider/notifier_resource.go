...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-notifiers/internal/resource_notifier"
	"github.com/nokia/eda/apps/terraform-provider-notifiers/internal/tfutils"
)

const (
	create_rs_notifier = "/apps/notifiers.eda.nokia.com/v1/namespaces/{namespace}/notifiers"
	read_rs_notifier   = "/apps/notifiers.eda.nokia.com/v1/namespaces/{namespace}/notifiers/{name}"
	update_rs_notifier = "/apps/notifiers.eda.nokia.com/v1/namespaces/{namespace}/notifiers/{name}"
	delete_rs_notifier = "/apps/notifiers.eda.nokia.com/v1/namespaces/{namespace}/notifiers/{name}"
)

var (
	_ resource.Resource                = (*notifierResource)(nil)
	_ resource.ResourceWithConfigure   = (*notifierResource)(nil)
	_ resource.ResourceWithImportState = (*notifierResource)(nil)
)
...
func (r *notifierResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_notifier, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_notifier, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_notifier,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *notifierResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_notifier, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *notifierResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_notifier, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
