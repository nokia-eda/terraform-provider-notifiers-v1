...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-notifiers/internal/eda/utils"
...
var _ provider.Provider = (*notifiersProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &notifiersProvider{version: ver}
	}
}

type notifiersProvider struct {
	version string
}
...
func (p *notifiersProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *notifiersProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *notifiersProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "notifiers-v1"
	resp.Version = p.version
}

func (p *notifiersProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewAppGroupDataSource,
		NewClusterNotifierDataSource,
		NewClusterNotifierListDataSource,
		NewClusterProviderDataSource,
		NewClusterProviderListDataSource,
		NewNotifierDataSource,
		NewNotifierListDataSource,
		NewProviderDataSource,
		NewProviderListDataSource,
		NewResourceListDataSource,
	}
}

func (p *notifiersProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		NewClusterNotifierResource,
		NewClusterProviderResource,
		NewNotifierResource,
		NewProviderResource,
	}
}
