...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-notifiers/internal/datasource_provider"
...
const read_ds_provider = "/apps/notifiers.eda.nokia.com/v1/namespaces/{namespace}/providers/{name}"
...
func (d *providerDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	err = d.client.GetByQuery(ctx, read_ds_provider, map[string]string{
...
func (r *providerDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
