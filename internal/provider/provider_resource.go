...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-notifiers/internal/resource_provider"
	"github.com/nokia/eda/apps/terraform-provider-notifiers/internal/tfutils"
)

const (
	create_rs_provider = "/apps/notifiers.eda.nokia.com/v1/namespaces/{namespace}/providers"
	read_rs_provider   = "/apps/notifiers.eda.nokia.com/v1/namespaces/{namespace}/providers/{name}"
	update_rs_provider = "/apps/notifiers.eda.nokia.com/v1/namespaces/{namespace}/providers/{name}"
	delete_rs_provider = "/apps/notifiers.eda.nokia.com/v1/namespaces/{namespace}/providers/{name}"
)
...
func (r *providerResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_provider, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_provider, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_provider,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *providerResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_provider, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *providerResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_provider, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
