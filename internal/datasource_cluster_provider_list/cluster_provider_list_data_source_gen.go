...
package datasource_cluster_provider_list
...
func ClusterProviderListDataSourceSchema(ctx context.Context) schema.Schema {
...
type ClusterProviderListModel struct {
